...
string determinarGrupoVencedor(int pontuacao1, int pontuacao2, int pontuacao3)
{
    if (pontuacao1 > pontuacao2 && pontuacao1 > pontuacao3) {
        ...
        return "Empate"; // Empate ou todos têm a mesma pontuação
    }
}
...
int main() {
    ...
    while (true) {
        ...
        if (cin.fail()) {
            ...
            while (grupoNumero != 5) {
                ...
                case 1:
                    ...
                    cout << "\033[1m===== Pergunta 3. Funções e Bibliotecas =====\033[1m\n" << endl;
                    ...
                    cout << "\033[1m===== Pergunta 4. Tópico: Vetores =====\033[1m\n" << endl;
        ...
        cout << "No final deu " << vencedor << endl;;
        return 0;
    }
}
